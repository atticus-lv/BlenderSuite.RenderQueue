...
public sealed class RenderTaskExecutionService : IRenderTaskExecutionService
{
    ...
    private static string BuildFinalFailureDetail(ExecutionContext context, Exception ex)
    {
        ...
        return category switch
        {
            ...
            "normal_quit" => BlenderRenderQueue.Localizer.Localizer.Instance["RenderTask_StatusDetail_NormalQuit"],
            "unexpected_exit" => context.WorkerExitedUnexpectedly
                ...
                : BlenderRenderQueue.Localizer.Localizer.Instance["RenderTask_StatusDetail_UnexpectedExit"],
            "render_timeout" => RenderTaskViewModel.FormatLocalized("RenderTask_StatusDetail_RenderTimeout", context.TaskTimeoutSeconds),
            "output_verification_failure" => BlenderRenderQueue.Localizer.Localizer.Instance["RenderTask_StatusDetail_OutputVerificationFailed"],
            "request_interrupted" => BlenderRenderQueue.Localizer.Localizer.Instance["RenderTask_StatusDetail_RequestInterrupted"],
            _ => string.IsNullOrWhiteSpace(ex.Message)
                ? BlenderRenderQueue.Localizer.Localizer.Instance["RenderTask_StatusDetail_RenderFailed"]
                : ex.Message
        };
    }
